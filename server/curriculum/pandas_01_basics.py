...
CHALLENGE_1 = {
    ...
    "instructions": (
        ...
        "4. Extracts the number of rows as an integer `num_rows = int(df.shape[0])` and columns `num_cols = int(df.shape[1])`.\n"
        "5. Extracts column names as a Python list of strings: `columns = list(df.columns)`.\n"
...
CHALLENGE_2 = {
    ...
    "instructions": (
        ...
        "3. Extracts data types as a dictionary mapping column name strings to dtype strings: `{col: str(dtype) for col, dtype in df.dtypes.items()}`.\n"
